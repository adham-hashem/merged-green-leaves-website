      ...
      <section className="py-16 sm:py-24 bg-gradient-to-b from-white to-green-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <div className="h-10 w-56 bg-gray-200 animate-pulse rounded-full mx-auto mb-4"></div>
            <div className="h-5 w-72 bg-gray-200 animate-pulse rounded-full mx-auto"></div>
          </div>
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-3 gap-6">
            {[...Array(6)].map((_, i) => (
              <div key={i} className="h-48 sm:h-56 bg-gray-250 animate-pulse rounded-2xl border border-gray-100/50 shadow-sm relative overflow-hidden bg-gradient-to-br from-gray-100 to-gray-200/60"></div>
            ))}
          </div>
        </div>
      </section>
