    ...
    return (
      <div>
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
          ...
          <div className="h-12 w-48 bg-gray-200 animate-pulse rounded-xl"></div>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[...Array(6)].map((_, i) => (
            <div key={i} className="bg-white rounded-2xl shadow-md p-6 h-64 animate-pulse flex flex-col justify-between border border-gray-100/50">
              ...
              <div className="h-4 w-full bg-gray-200 rounded-md mt-6"></div>
            </div>
          ))}
        </div>
      </div>
